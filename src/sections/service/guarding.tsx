  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20 text-center">
        ...
        >
          Our trained security guards ensure safety for businesses, events, and
          residential areas with professionalism and dedication.
        </motion.p>
      </section>
      ...
      <section className="py-20 px-6 md:px-16 grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            We provide well-trained and licensed guards who are experienced in
            handling crowd control, monitoring, and maintaining secure
            environments.
          </p>

          <div className="space-y-4">
            {[
              { icon: <Users />, text: "Experienced & Licensed Guards" },
              { icon: <Clock />, text: "24/7 Availability & Monitoring" },
              { icon: <ShieldCheck />, text: "Customized Security Solutions" },
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
      ...
      <section className="bg-blue-900 text-white text-center py-16">
        ...
        >
          Need Professional Guards for Your Property?
        </motion.h2>
        <motion.a
          href="/contact"
